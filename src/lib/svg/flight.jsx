...
const FlightIcon = ({ active = false, width="45px", height="45px", ...props }) => (
  <svg
    width={width}
    height={height}
    viewBox="0 0 32 32"
  ...
  >
    <g id="Airplane_x2C__plane_x2C__flight_1_">
      <g id="XMLID_94_">
        ...
        <line id="XMLID_1645_" x1="10.5" x2="4" y1="21.5" y2="28" />

        <path d="    M27.498,3.502c0.552,0,1,0.448,1,1" id="XMLID_100_" />
      </g>
    </g>
  </svg>
);
